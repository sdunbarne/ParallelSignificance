...
\item
    ...
    trajectories, \( X_{n+1}, \dots, X_{2k} \) and \( X_{n-1}, X_ {k-2},
    \dots, X_0 \) both beginning from \( \sigma \).
\item
    Let \( A \) and \( B \) be the events \( v(X_n) \) is an \( \epsilon
    \)-outlier among the lists \( v(X_0), \dots, v(X_k) \) and \( v(X_n),
    \dots, v(X_{2k}) \), respectively. Then
    \begin{equation}
    ...
    \begin{enumerate}
        ...
        \item
            ...
            \[
                ...
                {n_1} = \sigma}
            \] where, in this last expression, \( n_1 \) and \( n_2 \)
        ...
        \item
            ...
            random \( \sigma \sim \pi \),
            \[
                \Prob{p(\mu; 0, \epsilon | \sigma)} \ge \Prob{p(\mu; 0,
        ...
        \item
            ...
            \[
                \alpha \cdot p(\mu; 0, \epsilon | \sigma)^{2} \le \Esub{\sigma
                  \sim \pi} \le \Prob{v(X_{n_1})} \text{ is an
        ...
        \item
            ...
            of the trajectory, \( k_1 \) is uniformly distributed in the
        ...
        \item
            ...
            \( \epsilon \) since \( X_{k_1} \) is a uniformly randomly
