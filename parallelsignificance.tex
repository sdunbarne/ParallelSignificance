...
\begin{remark}
    See Figure~%
    \ref{fig:significance:test} for a schematic diagram of the
    Besag-Clifford Test.
\end{remark}

\begin{proof}
    See below, following the proof of Theorem~%
    \ref{thm:significance:thm6}
\end{proof}
...
\begin{remark}
    ...
    \ref{thm:significance:bc1} is that it achieves a best-possible
    ...
    \ref{thm:significance:bc1}.
\end{remark}

\begin{remark}
    One common feature of the tests based on Proposition~%
    \ref{thm:significance:basethm} and~%
    \ref{thm:significance:bc1} is the use of randomness.  In particular,
...
\begin{example}
    ...
    \) from \( X \).
\end{example}
[Is it possible to make a graphic of what this means?]
...
\begin{theorem}
    \label{thm:significance:thm3point1}
    \begin{enumerate}
        \item
...
\begin{remark}
    ...
    \ref{thm:significance:thm3point1} connects the intuitive Local
    ...
    \ref{thm:significance:bc1} [Not sure what this is trying to say.]
\end{remark}
...
\begin{example}
    ...
    \ref{thm:significance:thm3point1} to Proposition~%
    \ref{thm:significance:basethm} and Theorem~%
    \ref{thm:significance:bc1}, consider the case of a state \( \sigma_0
    ...
    \ref{thm:significance:bc1}, one would hope to obtain significance
    approximately \( O(\epsilon') \).  Applying Theorem~%
    \ref{thm:significance:thm3point1}, we would expect to see \( p \)
...
\begin{remark}
    To prove Theorem~%
    \ref{thm:significance:thm3point1}, first prove the following, which
    has a quantitative dependence on \( \epsilon \) which is nearly as
    strong as in Theorem~%
    \ref{thm:significance:bc1}, while eliminating the need for the
    random choice of \( \xi \).
\end{remark}

\begin{theorem}
    \label{thm:significance:thm6}
    \begin{enumerate}
        \item
            Let \( X \) be a reversible Markov chain.
        \item
...
\begin{remark}
    Note that Theorem~%
    \ref{thm:significance:thm6} is equivalent to the statement that the
...
\begin{proof}
    \begin{enumerate}
        ...
        \item
            ...
            \ref{thm:significance:thm6} by noting that \( \rho(n; \ell,
            2k) \) is a lower bound on each \( \rho(j; \ell, n) \) and
            then applying the simple inequality
            \begin{equation}
                \label{eq:significance:eight} \sum\limits_{j=0}^k \rho(j;
                \ell, k) \le \ell + 1.
            \end{equation}
    \end{enumerate}
\end{proof}

\begin{proof}[Proof of Theorem~\ref{thm:significance:bc1}]
    \begin{enumerate}
        \item
            The proof uses only equation~%
            \eqref{eq:significance:eight}
        \item
            Recall from the proof of Theorem~%
            \ref{thm:significance:thm6} that the \( \rho(j; \ell, n) \)
        ...
        \item
            ...
            \] using equation~\eqref{eq:significance:eight}.
        \item
...
\begin{proof}[Proof of Theorem~\ref{thm:significance:thm3point1}]
    \begin{enumerate}
        \item
        ...
        \item
            ...
            \alpha) \)-outlier, then
            \begin{equation}
                \label{eq:significance:nine} p(0; \epsilon, k \given
        ...
        \item
            ...
            Then
            \begin{equation}
                \label{eq:significance:eleven} (p(0; \epsilon, k \given
        ...
        \item
            ...
            random \( \sigma \sim \pi \)
            \begin{equation}
                \label{eq:significance:twelve} \Prob{ p(0; \epsilon, k
                \given \sigma) \ge p(0; \epsilon, k \given \sigma_0) }
                \ge \alpha.
            \end{equation}
        \item
            Equations~\eqref{eq:significance:eleven} and~\eqref{eq:significance:twelve}
            gives \( (p(0; \epsilon, n \given \sigma))^2 \le (p(k,
            \epsilon, 2k \given \sigma))^2 \) while Theorem~%
            \ref{thm:significance:thm6} gives \( (p(0; \epsilon, n
        ...
        \item
            ...
            \]
        \item
            On the other hand, with~\eqref{eq:significance:twelve}
            \[
                \Esub{\sigma \sim \pi}{(p(0; \epsilon, k \given \sigma))^2
...
\begin{remark}
    ...
    the Chernoff bound in~\eqref{eq:significance:eleven} may be
    sensible.  This gives the following Corollaries.
\end{remark}

\begin{corollary}
    Given the hypotheses in Theorem~%
    \ref{thm:significance:thm3point1}, then
    \[
        \Prob{\mathcal{N} \ge K} \le \sum\limits_{\nu=K}^m \binom{m}{\nu}
...
\ref{thm:significance:thm3point1} directly in the current Markov chain
...
\ref{thm:significance:thm3point1} to achieve some desired trade-off
...
\ref{thm:significance:thm3point1}, \( \epsilon = \epsilon(t) \),
...
\ref{thm:significance:thm3point1} in this scenario, the probability of
